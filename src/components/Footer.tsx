...
//               </div>
//               <div>
//                 <span className="text-2xl font-bold">RizqTek</span>
//                 <div className="text-green-400 text-sm">Sustaining Futures with Ethical Tech</div>
//               </div>
//             </button>
...
//                 <span className="text-gray-300">hello@rizqtek.com</span>
//               </div>
//               <div className="flex items-center space-x-3">
...
//               <li><a href="#" className="text-gray-300 hover:text-green-400 transition-colors">Data Analytics</a></li>
//               <li><a href="#" className="text-gray-300 hover:text-green-400 transition-colors">Automation Tools</a></li>
//               <li><a href="#" className="text-gray-300 hover:text-green-400 transition-colors">Web Development</a></li>
//               <li><a href="#" className="text-gray-300 hover:text-green-400 transition-colors">AI Career Tools</a></li>
//               <li><a href="#" className="text-gray-300 hover:text-green-400 transition-colors">SaaS Solutions</a></li>
//             </ul>
//           </div>
...
//               <li><a href="#industries" className="text-gray-300 hover:text-green-400 transition-colors">Industries</a></li>
