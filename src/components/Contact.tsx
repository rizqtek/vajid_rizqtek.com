            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl">
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">hello@rizqtek.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">Global Remote Team</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 p-6 rounded-2xl">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <span className="font-semibold text-green-800">24/7 Support Available</span>
                </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-3xl shadow-xl">
              ...
              <div className="space-y-6">
                ...
                {formData.service === 'payment' && (
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Project/Client ID</label>
                    <input
                      type="text"
                      name="projectId"
                ...
                <button
                  ...
                  className="w-full bg-green-600 text-white px-6 py-4 rounded-lg font-semibold hover:bg-green-700 transition-all duration-300 flex items-center justify-center space-x-2 group disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
